...
def main():
    for line_num in range(len(objectBoxCenters))[200:1850]:
        ...
        head_pos = gaze_ray_list[0].head_pos_IBEO

        #PLOT THE GAZE LINES
        for gaze_ray in gaze_ray_list:
            vector_gaze = gaze_ray.gaze_vec_IBEO
            plot_line_3D(axes, head_pos, vector_gaze, length=50, color='#000000', linewidth = 0.5)
